...
//    @Autowired
//    private AppCommonMyBatisProperties appCommonMyBatisProperties;
    ...
    public DataSource myBatisDataSource() throws SQLException {
        ...
        dataSource.setUrl("jdbc:mysql://rm-uf6bh9624e326g70xo.mysql.rds.aliyuncs.com:3306/contentmanagersystem_db?autoReconnect=true&useUnicode=true&characterEncoding\\=utf-8");
        dataSource.setUsername("root");
        dataSource.setPassword("Yxb900903#");
...
//    }
    ...
    public SqlSessionFactory myBatisSqlSessionFactory(DataSource myBatisDataSource) throws Exception {
        ...
        //实体类扫描路径
        sessionFactory.setTypeAliasesPackage("com.yxb.cms.domain.vo");
        //Mapper文件位置
